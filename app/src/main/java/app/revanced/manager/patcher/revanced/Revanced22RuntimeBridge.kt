...
object Revanced22RuntimeBridge {
    private const val ENTRY_CLASS_NAME = "app.revanced.manager.revanced.runtime.RevancedRuntimeEntry"
    private const val CALLBACK_CLASS_NAME = "app.revanced.manager.revanced.runtime.RevancedRuntimeCallback"
    ...
    private fun ensureClassLoader(): DexClassLoader {
        val context = appContext ?: error("Revanced22RuntimeBridge is not initialized.")
        val runtimeClassPathFile = Revanced22RuntimeAssets.ensureRuntimeClassPath(context)
...
class Revanced22BridgeFailureException(val originalStackTrace: String) :
    Exception("ReVanced in-process fallback patcher failed")
