...
fun SettingsScreen(onBackClick: () -> Unit, navigate: (Settings.Destination) -> Unit) {
    ...
    val settingsEntries = remember {
        listOf(
            ...
            SearchEntry(R.string.process_runtime_memory_aggressive, R.string.process_runtime_memory_aggressive_description, R.string.patcher_category, Settings.Patcher),
            ...
            SearchEntry(R.string.patch_selection_action_order_title, R.string.patch_selection_action_order_description, R.string.patcher_category, Settings.Patcher),
            SearchEntry(R.string.patch_selection_action_visibility_title, R.string.patch_selection_action_visibility_description, R.string.patcher_category, Settings.Patcher),
            ...
            SearchEntry(R.string.patch_bundle_action_order_title, R.string.patch_bundle_action_order_description, R.string.patcher_category, Settings.Patcher),
