...
object MorpheRuntimeBridge {
    private const val ENTRY_CLASS_NAME = "app.urv.manager.morphe.runtime.MorpheRuntimeEntry"
    private const val CALLBACK_CLASS_NAME = "app.urv.manager.morphe.runtime.MorpheRuntimeCallback"
