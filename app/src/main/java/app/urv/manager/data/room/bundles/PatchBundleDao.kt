package app.urv.manager.data.room.bundles
...
interface PatchBundleDao {
    ...
    @Query("SELECT name, display_name, version, auto_update, search_update, last_notified_version, source, enabled, sort_order, created_at, updated_at FROM patch_bundles WHERE uid = :uid")
