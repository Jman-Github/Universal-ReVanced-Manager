...
object SplitApkPreparer {
            ...
            while (true) {
                ...
                try {
                    ...
                    val retrySkippedModules =
                        buildRetrySkippedModules(mergeOrder, skippedModules)
    ...
    private fun buildRetrySkippedModules(
        ...
        return buildSet {
            ...
            addAll(unusedAbiModules(moduleNames))
            // Keep only locale/density splits relevant to the current device on retry.
            addAll(unneededSplitModules(moduleNames, localeTokens, densityQualifier))
        }
    }
