...
-keep class app.urv.manager.ample.runtime.** { *; }

# Keep IPC classes used across process boundaries.
-keep class app.urv.manager.patcher.runtime.process.** { *; }

# Keep Ample (ReVanced) patcher/library API classes that are accessed via reflection.
...
# Keep dexlib2/smali types used by Ample patch loader via reflection.
